        ...
        <div className=" w-full bg-white backdrop-blur-lg bg-opacity-20 shadow-lg rounded py-12 lg:px-28 px-8">
          ...
          <div className="flex items-center justify-center w-full">
            <button
              ...
              className="mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-blue-500 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none"
            >
              SUBMIT
            </button>
          </div>
