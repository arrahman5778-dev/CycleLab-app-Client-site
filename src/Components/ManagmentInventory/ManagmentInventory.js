  ...
  return (
    <div className="py-20 ">
      <div className="bgStyles border-2 w-[330px] md:w-[400px] lg:w-[550px] mx-auto p-5 text-xl text-black font-medium  rounded-2xl shadow-2xl">
        <img
          className="w-fit mx-auto rounded-2xl mb-4"
          src={product.image}
          alt=""
        />
        <p className="text-2xl font-semibold font-mono text-blue-700 mb-1">
          {product.name}
        </p>
        <hr className=" border-blue-400 w-1/2 mx-auto mb-5" />

        <div className="flex justify-between items-center mb-4 px-5">
          <p>
            Price:{" "}
            <span className=" text-fuchsia-800 font  font-semibold text-lg">
              ${product.price}
            </span>
          </p>
          <p>
        ...
        <button
          onClick={CountHandel}
          className=" mt-5 bg-fuchsia-800 text-white rounded px-3 py-1 mx-8 mb-4"
        >
          Delivered
        </button>

        <div>
          <h1 className="mt-7 mb-2 text-xl font-mono text-fuchsia-800 font-semibold">
            Restock Quantoity
          </h1>
          <hr className=" border-fuchsia-800 w-3/4 mx-auto mb-5" />
          <form className=" text-left" onSubmit={QuantityInputAdd}>
            <label
              className=" text-left font-mono text-lg font-semibold "
              htmlFor="QuantityValue"
            >
              Add Quantity :
            </label>
            <input
              className="text-black w-full outline-none border-fuchsia-800 border-2 rounded-lg mb-4 px-3 py-1 pb-2 mt-2 placeholder:text-base"
              id="QuantityValue"
              type="number"
              name="QuantityValue"
            ...
            <div className="text-center">
              <input
                type="submit"
                value="Submit"
                className=" bg-green-800 text-white mx-8  rounded px-4 py-1 mb-4"
              />
            </div>
          </form>
        </div>
      ...
      <div className="md:w-[400px] w-1/2 mx-auto my-20 text-center">
        <Link
          to="/manageItem"
          className=" text-center  flex justify-center mt-2 items-center md:px-8 px-2 py-1 rounded-xl shadow-lg bg-fuchsia-800 text-white  font-semibold font-mono"
        >
