                    ...
                    <div className=" p-5 mt-[8rem]   bg-opacity-60 backdrop-blur-lg rounded-lg ">
                        ...
                        <form onSubmit={handelsubmit} className='text-black'>
                            ...
                            <div className='mb-2'>
                                ...
                                <input type="submit" className='w-full bg-blue-500 shadow-md py-2 text-2xl rounded text-white' value='Register' />
                            </div>
                            <p className=' font-mono font-medium mt-8'>Allrady have an account? <span onClick={() => navigate('/login')} className=' text-blue-800 cursor-pointer font-mono font-bold text-xl '>Log In</span></p>
