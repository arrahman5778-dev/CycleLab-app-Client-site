      ...
      <div className="mb-24 mx-5 ">
        <div className="w-full lg:w-1/2 md:w-3/4 mx-auto bg-opacity-90 shadow-lg relative">
          <div className=" p-5 mt-[8rem]   bg-opacity-60 backdrop-blur-lg rounded-lg ">
            <h1 className="text-4xl font-semibold mb-5 text-blue-500">
              log In
            </h1>
            ...
            <div className="flex flex-col text-left mb-8">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full py-2 rounded-lg shadow-md border-0 outline-0 px-4 text-xl "
                ...
                <div
                  onClick={toggleBtn}
                  className="w-6 absolute right-4 top-[25%]"
                >
            ...
            <div className="btn-container mt-10 mb-3">
              <button
                onClick={handelLogin}
                className="w-full bg-blue-500 shadow-md py-2 text-2xl rounded text-white mb-8"
              >
                Log In
              </button>
            </div>
            <p className=" font-mono font-medium">
              ...
              <span
                ...
                className=" text-blue-600 cursor-pointer font-mono font-bold text-xl"
              >
                Register
              </span>
            </p>
