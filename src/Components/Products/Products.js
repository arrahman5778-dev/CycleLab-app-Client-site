...
const Products = () => {
    ...
    return (
        <div className='my-8 bg-blue-50'>
            <h1 className='text-5xl font-mono text-blue-700'>Inventory</h1>
                                ...
                                <section class="flex flex-col md:flex-row gap-10 py-10 px-4 mx-auto lg:mx-0  rounded-md shadow-lg w-full md:max-w-2xl bg-white bg-opacity-60 backdrop-blur-md">
                                    ...
                                    <div class="text-indigo-500 w-full md:w-[50%]">
                                        ...
                                        <div className='mt-5 text-right'>
                                            <button onClick={() => navigate(`/managmentInventory/${product._id}`)} id="addToCartButton" class="bg-blue-500 hover:bg-indigo-500 focus:outline-none transition text-white uppercase px-8 py-2 rounded-sm">Update</button>
                                        </div>
                                    </div>
                                </section>
                            </main>
            ...
            <div className='w-[300px] mx-auto mb-28'>
                <Link to='/manageItem' className='  flex justify-center mt-2 items-center px-8 py-1 rounded-xl shadow-lg bg-blue-500 text-white  font-semibold font-mono'>
