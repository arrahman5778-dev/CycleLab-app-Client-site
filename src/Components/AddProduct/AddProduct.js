...
const AddProduct = () => {
  ...
  return (
    <div className="py-32 md:px-10 px-3 min-h-screen w-full ">
      <h1 className="text-center text-4xl font-mono text-blue-800 font-bold ">
        Add Your Product
      </h1>
        ...
        <div className="  md:p-10 p-3  w-full  bg-opacity-90 backdrop-blur-lg shadow-lg ">
          <form onSubmit={handleSubmit}>
            <div className="flex items-center mb-10">
              <label className="inline-block w-40 mr-6 text-right font-bold text-blue-400">
                Name :
              </label>
              <input
                type="text"
                ...
                className="flex-1 py-2 border-b-2 border-green-600 focus:border-blue-700 
            ...
            <div className="flex items-center mb-10">
              <label className="inline-block w-40 mr-6 text-right font-bold text-blue-500 ">
                Price :
              </label>
              <input
                type="text"
                ...
                className="flex-1 py-2 border-b-2 
                                bg-transparent border-green-600 focus:border-blue-700 
                      text-black placeholder-black
                      outline-none"
                required
              />
            ...
            <div className="flex items-center mb-10">
              ...
              <input
                ...
                className="flex-1 py-2 border-b-2 bg-transparent border-green-600 focus:border-blue-700 
                                text-black placeholder-black
                      outline-none"
                required
              />
            ...
            <div className="flex items-center mb-10">
              ...
              <input
                ...
                className="flex-1 py-2 border-b-2 bg-transparent 
                                border-green-600 focus:border-blue-700 
                                text-black placeholder-black
                      outline-none"
                required
              />
            ...
            <div className="text-right">
              <button className="py-2 px-10 rounded-lg  bg-blue-500 text-white font-bold">
                Add
              </button>
            </div>
          </form>
